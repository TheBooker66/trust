...
SLIDES.push({
    onstart: function (self) {
        ...
        // What was your bet?
        let tournament_intro = Words.get("tournament_intro");
...
SLIDES.push({
    onstart: function (self) {
        ...
        const showTournament = function (num) {

            let words = "";
            let match_header;

            // PLAY MATCH
            const matchData = o.tournament.playMatch(num);
            const charA = matchData.charA;
            const charB = matchData.charB;
            let scoreA = matchData.scoreA;
            let scoreB = matchData.scoreB;
            const roundPayoffs = matchData.payoffs;
            ...
            for (let i = 0; i < roundPayoffs.length; i++) {
                let payoff = roundPayoffs[i][0];
