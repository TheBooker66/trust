...
SLIDES.push({
    ...
    onstart: function (self) {
        ...
        self.add({
            ...
            x: 0, y: 370, width: 717, height: 95, align: "left", dir: "ltr",
        ...
        // Button
        self.add({
            id: "button", type: "Button", x: 0, y: 466, dir: "ltr",
...
SLIDES.push({
    onstart: function (self) {
        ...
        // What was your bet?
        let response = Words.get("evo_2_" + _.answer) + " " + Words.get("evo_2");
        ...
        let _showButtons = function () {
            _hide(o.step_1);
            _fadeIn(o.step_1, 500);
            _hide(o.step_2);
            _fadeIn(o.step_2, 600);
            _hide(o.step_3);
            _fadeIn(o.step_3, 700);
        };
        _showButtons();
...
SLIDES.push({
    onstart: function (self) {
        ...
        // What was your bet?
        const response = Words.get("evo_9") + "<br><br>" + Words.get("evo_9_" + _.answer) + " " + Words.get("evo_9_end");
        o.text.setText(response);
        _hide(o.text);
        _fadeIn(o.text, 100);
...
SLIDES.push({
    onstart: function (self) {
        ...
        _hide(o.autoplay);
        _fadeIn(o.autoplay, 1200);

        // Listen...
        let step = 0;
        listen(_, "tournament/step/completed", function () {
            step++;
            if (step === 13) {
                _goOn();
            }
