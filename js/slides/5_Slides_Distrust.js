SLIDES.push({
    ...
    onstart: function (self) {
        ...
        _hide(o.playButton);
        _fadeIn(o.playButton, 800);
        _hide(o.stepButton);
        _fadeIn(o.stepButton, 900);
        _hide(o.resetButton);
        _fadeIn(o.resetButton, 1000);
...
SLIDES.push({
    onstart: function (self) {
        ...
        _updateLabel(10);
        _hide(o.roundsLabel);
        _fadeIn(o.roundsLabel, 500);
        _hide(o.roundsSlider);
        _fadeIn(o.roundsSlider, 500);

        // Continue...
        listen(_.misc, "tournament/autoplay/start", function () {
            if (_showContinue) _showContinue();
        });
        let _showContinue = function () {
            _showContinue = null;
            const x = 125;
            const y = 430;
            self.add({
...
SLIDES.push({
    onstart: function (self) {
        ...
        _hide(o.payoffs);
        _fadeIn(o.payoffs, 300);
        listen(_.misc, "payoffs/onchange", function () {
            o.tournament.reset();
        });
