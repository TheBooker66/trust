...
SLIDES.push({
    ...
    onstart: function (self) {
        ...
        // Re-activate...
        let _foreverWar = false;
        let _foreverMove = "cheat";
...
SLIDES.push({
    ...
    onstart: function (self) {
        ...
        // BETS
        const _addButton = function (character, x, y) {
...
SLIDES.push({
    onstart: function (self) {
        ...
        // Words
        let words = Words.get("noise_evo_2").replace(/\[CHAR\]/g, "<span class='" + _.answer + "'>" + Words.get("label_" + _.answer) + "</span>");
        ...
        listen(_.misc, "tournament/step/completed", function (step) {
            if (step == "reproduce") {
                ...
                if (reproduceSteps == 6) {
                    ...
                    // WORDS
                    let words = (_.answer == "pavlov") ? Words.get("noise_evo_2_2_correct") : Words.get("noise_evo_2_2_incorrect");
                    words += " ";
...
SLIDES.push({
    onstart: function (self) {
        ...
        // HIDE PLAYER
        _hide(o.playButton);
        o.playButton.deactivate();
        _hide(o.stepButton);
        o.stepButton.deactivate();
        _hide(o.resetButton);
        o.resetButton.deactivate();
...
SLIDES.push({
    onstart: function (self) {
        ...
        // SHOW PLAYER
        _fadeIn(o.playButton, 1);
        o.playButton.activate();
        _fadeIn(o.stepButton, 1);
        o.stepButton.activate();
        _fadeIn(o.resetButton, 1);
        o.resetButton.activate();
        o.playButton.setText("label_start");

        // Words
        let words = Words.get("noise_evo_4").replace(/\[CHAR\]/g, "<span class='" + _.answer + "'>" + Words.get("label_" + _.answer) + "</span>");
        o.text.setText(words);
        _hide(o.text);
        _fadeIn(o.text, 100);
        ...
        listen(_.misc, "tournament/step/completed", function (step) {
            if (step == "reproduce") {
                ...
                if (reproduceSteps == 8) {
                    ...
                    // WORDS
                    let words = (_.answer == "tf2t") ? Words.get("noise_evo_4_2_correct") : Words.get("noise_evo_4_2_incorrect");
                    words += " ";
...
SLIDES.push({
    onstart: function (self) {
        ...
        const _updateLabel = function (value) {
        ...
        _updateLabel(0.05);
        _hide(o.noiseLabel);
        _fadeIn(o.noiseLabel, 300);
        _hide(o.noiseSlider);
        _fadeIn(o.noiseSlider, 300);
        ...
        _showContinue = function () {
            ...
            _hide(o.continueLabel);
            _fadeIn(o.continueLabel, 100);
            _hide(o.continueButton);
            _fadeIn(o.continueButton, 100);
        };
