SLIDES.push({
    ...
    onstart: function (self) {
        ...
        // Hide & fade
        _hide(o.topWords);
        _fadeIn(o.topWords, 150 + 10);
        _hide(o.btmWords);
        _fadeIn(o.btmWords, 150 + 600);
        _hide(o.buttonCheat);
        _fadeIn(o.buttonCheat, 150 + 1200);
        _hide(o.buttonCooperate);
        _fadeIn(o.buttonCooperate, 150 + 1200);
...
SLIDES.push({
    ...
    onstart: function (self) {
        ...
        const _showInfo = function () {
            let infoWords = Words.get("iterated_info_1");
            infoWords += "<br>";
...
SLIDES.push({
    ...
    onstart: function (self) {
        ...
        self.add({
            ...
            x: 720, y: 32, width: 243, height: 26, dir: "rtl",
        ...
        self.add({
            ...
            x: 640, y: 84, width: 151, height: 132, align: "right", size: 123, dir: "rtl",
        ...
        self.add({
            ...
            x: 24, y: 62, width: 639, height: 123, dir: "rtl",
        ...
        self.add({
            ...
            x: 39, y: 208, width: 470, height: 114, dir: "rtl",
            character: "tft"
        });
        self.add({
            id: "char_all_d", type: "CharacterTextBox",
            x: 511, y: 208, width: 190, height: 114, dir: "rtl",
            character: "all_d"
        });
        self.add({
            id: "char_all_c", type: "CharacterTextBox",
            x: 731, y: 208, width: 220, height: 114, dir: "rtl",
            character: "all_c"
        });
        self.add({
            id: "char_grudge", type: "CharacterTextBox",
            x: 39, y: 333, width: 380, height: 114, dir: "rtl",
            character: "grudge"
        });
        self.add({
            id: "char_prober", type: "CharacterTextBox",
            x: 431, y: 333, width: 500, height: 114, dir: "rtl",
            character: "prober"
        });
        ...
        self.add({
            ...
            x: 484, y: 478, width: 447, height: 37, dir: "rtl",
            text_id: "characters_teaser"
        });

        // Next Button!
        self.add({
            id: "next_button", type: "Button", x: 94, y: 491, size: "long", dir: "rtl",
